<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/UserMaster.Master" CodeBehind="UserPProfesional.aspx.cs" Inherits="Administracion.UserPProfesional" %>
                                        ...
                                        <div class="panel-body" style="background-color: transparent">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 text-center-md item-caption">
                                                        <button id="btnPDF" onclick="downloadPDF('Perfil Profesional')" class="btn btn-primary btn-hh-trigger">Descargar como PDF</button>
                                                    </div>
                                                </div>
