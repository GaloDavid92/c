<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/UserMaster.Master" CodeBehind="UserPReingreso.aspx.cs" Inherits="Administracion.UserPReingreso" %>
                                        ...
                                        <div class="panel-body" style="background-color: transparent">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 text-center-md item-caption">
                                                        <button id="btnPDF" onclick="downloadPDF('Proceso de Reingreso')" class="btn btn-primary btn-hh-trigger">Descargar como PDF</button>
                                                    </div>
                                                </div>
                                                <div class="col-sm-12 col-sm-offset-0">
                                                    <div class="form-group">
