<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/UserMaster.Master" CodeBehind="UserPCamCarrera.aspx.cs" Inherits="Administracion.UserPCamCarrera" %>
                    ...
                    <ContentTemplate>
                        ...
                        <div class="panel panel-pricing" style="background-color: transparent">
                            <div class="panel-heading text-center" style="color: orange">
                                <h1>Proceso de Cambio de Carrera
                                </h1>
                            </div>
                            <div class="panel-body" style="background-color: transparent">
                                <div runat="server" id="carrera" visible="true">
                                    <div class="panel panel-pricing" style="background-color: transparent">
                                        ...
                                        <div class="panel-body" style="background-color: transparent">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 text-center-md item-caption">
                                                        <button id="btnPDF" onclick="downloadPDF('Proceso de Cambio de Carrera')" class="btn btn-primary btn-hh-trigger">Descargar como PDF</button>
                                                    </div>
                                                </div>
                                                <div class="col-sm-12 col-sm-offset-0">
                                                    <div class="form-group">
                            ...
                            <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <asp:Button ID="Button1" runat="server" class="btnEnviar btn btn-primary btn-hh-trigger" Text="Enviar" OnClick="btnEnviar_Click" OnClientClick="hideBack()" disabled/>
