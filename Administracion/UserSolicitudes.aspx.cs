...
{
    public partial class UserSolicitudes : System.Web.UI.Page
    {
        ...
        private void CargarDatos()
        {
            ...
            {
                if (item.Tipo == "Solicitud" && item.IdMalla == (int)Session["IdMallaU"])
                    n1++;
            }

            var agregar = (from a in db.FormSoli
                           where (a.Tipo == "Solicitud") && a.IdMalla == (int)Session["IdMallaU"]
                           select a).ToList();
