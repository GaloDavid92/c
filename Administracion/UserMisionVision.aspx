<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/UserMaster.Master" CodeBehind="UserMisionVision.aspx.cs" Inherits="Administracion.UserMisionVision" %>
                        ...
                        <div class="panel panel-pricing" style="background-color: transparent">
                            ...
                            <div class="panel-body" style="background-color: transparent">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 text-center-md item-caption">
                                        <button id="btnPDF" onclick="downloadPDF('Misión y Visón')" class="btn btn-primary btn-hh-trigger">Descargar como PDF</button>
                                    </div>
                                </div>
