<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/AdminMaster.Master" CodeBehind="AdminSolicitudes.aspx.cs" Inherits="Administracion.AdminSolicitudes" %>
                                             ...
                                             <div class="col-sm-3 col-sm-offset-1">
                                                    <div class="form-group">
                                                        <div class="input-group input-group-lg text-center">
                                                            <asp:Label ID="lblNombre" runat="server" Text="Nombre de Solicitud:"></asp:Label>
                                                        </div>
                                                    </div>
                                                </div>
                                            <div class="col-sm-4">
